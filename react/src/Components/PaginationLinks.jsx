    ...
    <div className="flex items-center justify-between border-t border-gray-200 bg-white px-4 py-3 sm:px-6 shadow-md mt-4">
      ...
      <div className="hidden sm:flex sm:flex-1 sm:items-center sm:justify-between">
        ...
        <div>
          ...
          {meta.total > 2 && <nav className="isolate inline-flex -space-x-px rounded-md shadow-sm" aria-label="Pagination">
            ...
            {meta.links && meta.links.map((link,ind) => (
              ...
              aria-current="page"
              className={"relative z-10 inline-flex items-center border px-4 py-2 text-sm font-semibold text-gray-500 focus:z-20 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 hover:bg-gray-50" + (ind === 0 ? 'rounded-l-md': '') + (ind === meta.links.length - 1 ? 'rounded-r-md': '') + (link.active ? 'bg-indigo-50 border-indigo-500 text-indigo-600 border-r-2': '')
            }
