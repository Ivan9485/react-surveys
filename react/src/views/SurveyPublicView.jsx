...
export default function SurveyPublicView() {
  ...
  return (
    ...
    {!loading && (
      ...
      <p className="text-gray-500 text-sm mb-3">{survey.expire_date}</p>
      ...
      <button type="submit" className="inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:right-2 focus:ring-offset-2 focus:ring-indigo-500">
        Submit
      </button>
        </>
      )}
